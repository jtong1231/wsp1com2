...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.57.129.158"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 24786;
pub const RELAY_PORT: i32 = 24787;
pub const WS_RENDEZVOUS_PORT: i32 =24788;
pub const WS_RELAY_PORT: i32 = 24789;
