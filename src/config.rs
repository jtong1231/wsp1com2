...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.252.62.117"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 28086;
pub const RELAY_PORT: i32 = 28087;
pub const WS_RENDEZVOUS_PORT: i32 =28088;
pub const WS_RELAY_PORT: i32 = 28089;
