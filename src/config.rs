...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.91.112.18"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 25986;
pub const RELAY_PORT: i32 = 25987;
pub const WS_RENDEZVOUS_PORT: i32 =25988;
pub const WS_RELAY_PORT: i32 = 25989;
