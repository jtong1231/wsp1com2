...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.211.36.4"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 23986;
pub const RELAY_PORT: i32 = 23987;
pub const WS_RENDEZVOUS_PORT: i32 =23988;
pub const WS_RELAY_PORT: i32 = 23989;
