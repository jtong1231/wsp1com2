...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.181.135.222"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 28186;
pub const RELAY_PORT: i32 = 28187;
pub const WS_RENDEZVOUS_PORT: i32 =28188;
pub const WS_RELAY_PORT: i32 = 28189;
