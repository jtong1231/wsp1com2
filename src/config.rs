...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.211.36.5"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 24386;
pub const RELAY_PORT: i32 = 24387;
pub const WS_RENDEZVOUS_PORT: i32 =24388;
pub const WS_RELAY_PORT: i32 = 24389;
