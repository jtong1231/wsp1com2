...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("迅慧联".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.57.129.196"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 24186;
pub const RELAY_PORT: i32 = 24187;
pub const WS_RENDEZVOUS_PORT: i32 =24188;
pub const WS_RELAY_PORT: i32 = 24189;
