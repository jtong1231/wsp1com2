...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.252.62.114"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 26286;
pub const RELAY_PORT: i32 = 26287;
pub const WS_RENDEZVOUS_PORT: i32 =26288;
pub const WS_RELAY_PORT: i32 = 26289;
