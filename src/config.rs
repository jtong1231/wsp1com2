...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.45.123.75"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 25886;
pub const RELAY_PORT: i32 = 25887;
pub const WS_RENDEZVOUS_PORT: i32 =25888;
pub const WS_RELAY_PORT: i32 = 25889;
