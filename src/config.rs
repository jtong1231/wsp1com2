...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("左简宝".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.181.135.218"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 25786;
pub const RELAY_PORT: i32 = 25787;
pub const WS_RENDEZVOUS_PORT: i32 =25788;
pub const WS_RELAY_PORT: i32 = 25789;
