...
pub const RENDEZVOUS_SERVERS: &[&str] = &["154.92.255.246"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 28286;
pub const RELAY_PORT: i32 = 28287;
pub const WS_RENDEZVOUS_PORT: i32 =28288;
pub const WS_RELAY_PORT: i32 = 28289;
