...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.46.14.19"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 25286;
pub const RELAY_PORT: i32 = 25287;
pub const WS_RENDEZVOUS_PORT: i32 =25288;
pub const WS_RELAY_PORT: i32 = 25289;
