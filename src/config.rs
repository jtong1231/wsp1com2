...
pub const RENDEZVOUS_SERVERS: &[&str] = &["38.91.112.20"];
pub const RS_PUB_KEY: &str = "Vstk4Hr0UOIG86luHpCqA16GhBpMc4vKbpX3qHF9wpU=";
pub const RENDEZVOUS_PORT: i32 = 27186;
pub const RELAY_PORT: i32 = 27187;
pub const WS_RENDEZVOUS_PORT: i32 =27188;
pub const WS_RELAY_PORT: i32 = 27189;
